...
// 结构：① 昆明/弥勒/抚仙湖慢游，爸爸从抚仙湖接爷爷 ② 09-26六口转场大理，连住四晚后直接去普洱，再到西双版纳 ③ 爷爷奶奶动车返昆，其余四人开车返昆
...
export const tripMeta = {
  ...
  theme: "全程主打：🏖️高原湖玩沙亲水 · 🌸弥勒当季花景 · 🏞️洱海田园与白族非遗 · 🐾普洱森林动物 · ☕茶咖体验 · 🐘雨林傣家",
  images: {
...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      "入住位置便利、有餐厅和亲子设施的湖景酒店，连续住三晚不搬行李",
      "傍晚小湾村或酒店湖岸看落日"
    ],
    play: ["小湾村", "湖岸落日", "亲子酒店"],
    hotel: "抚仙湖东岸或北岸湖景亲子酒店（连住3晚）",
  ...
  },
  {
    ...
    schedule: [
      ...
      "下午抵达大理，入住洱海西岸同一家亲子酒店连住四晚",
      "傍晚只在酒店附近看洱海日落，全家早休息"
    ],
    play: ["抚仙湖晨景", "高速转场", "洱海日落"],
    hotel: "大理洱海西岸亲子酒店（连住4晚）",
...
export const globalTips = [
  { icon: "👨‍👩‍👧‍👦", title: "抚仙湖接爷爷", text: "09-23入住抚仙湖连住三晚；09-25爸爸单独往返长水机场接爷爷，其余家人在酒店休息；09-26早餐后六口一起前往大理。" },
  ...
  { icon: "😴", title: "大多数日子自然醒", text: "除09-26抚仙湖去大理、09-30大理去普洱、10-09普洱返昆三天需稍早出发，其余转场尽量控制在3小时以内，并给宝宝保留午睡。" },
