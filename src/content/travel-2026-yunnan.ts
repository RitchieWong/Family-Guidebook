...
export const tripMeta = {
  ...
  theme: "全程主打：🏖️高原湖玩水 · 🌸弥勒艺术花海 · 🏞️洱海田园 · 🐾普洱森林动物 · ☕茶咖庄园 · 🐘雨林傣家",
  images: {
...
export const routeStages = [
  ...
  { city: "普洱", alt: "约 1300m", days: "D12-D14", date: "09.30-10.02", drive: "约7—9h", phase: "far" },
...
export const mapPoints = [
  ...
  ["普洱", 100.972, 22.825, "D12-14", "hub", "约7—9h", "l"],
...
export const days = [
  ...
  },
  {
    ...
    hotel: "同昆明滇池酒店",
    tips: "滇池和湿地都比较平缓，作为落地后的适应日，不安排博物馆。"
  },
  {
  ...
  },
  {
    ...
    img: "mileTaiping",
    title: "弥勒慢玩 · 太平湖花海 + 湖泉生态园",
    schedule: [
      "自然醒后去太平湖森林小镇，坐观光车看花海和草坪",
      "午餐后回酒店午睡，不连续赶景点",
      "傍晚湖泉生态园散步、喂鱼，吃弥勒卤鸡和葡萄"
    ],
    play: ["太平湖花海", "观光车", "湖泉生态园"],
    hotel: "同弥勒酒店",
  ...
  },
  {
    ...
    hotel: "同抚仙湖酒店",
    tips: "机场到抚仙湖常态约1.5小时，国庆前周五可能拥堵；爸爸尽量提前出发，其他人当天不动酒店。"
  },
  {
    ...
    schedule: [
      "六口睡到自然醒，上午在禄充看湖、坐船或沿岸散步",
      "午餐吃铜锅鱼，回酒店午睡",
      "傍晚全家在湖边玩沙、拍合照、看日落"
    ],
    play: ["禄充湖岸", "游船", "玩沙", "六口合照"],
    hotel: "同抚仙湖酒店",
    tips: "满足爷爷到后再一起玩一天抚仙湖；下午继续保留午睡。"
  },
  {
    id: 9, date: "第9天 09-27 周日", city: "大理·洱海", alt: "约 1970m", drive: "抚仙湖→大理约 360km / 4.5—5.5h",
    img: "erhai",
    title: "抚仙湖 → 大理 · 全程高速直达洱海",
    schedule: [
      "当天比平时稍早退房，经昆明南侧转杭瑞高速向西",
      "途中至少进两次服务区，让宝宝下车活动并解决午餐",
      "下午抵达大理入住洱海西岸，傍晚只在酒店附近看日落"
    ],
    play: ["高速转场", "洱海日落"],
    hotel: "大理洱海西岸亲子酒店（连住3晚）",
    tips: "这是全程较长但以主干高速为主的一天；途中只在服务区休息，不增加城市停留。"
  },
  {
  ...
  {
    id: 12, date: "第12天 09-30 周三", city: "大理→普洱", alt: "约 1300m", drive: "约500—550km / 7—9h",
    img: "roadDaliPuer",
    title: "全程唯一超长日 · 大理直接开到普洱",
    schedule: [
      "这天不能等自然醒，建议07:30前离开大理；前一晚把行李和宝宝用品装车",
    ...
    hotel: "普洱市区亲子酒店（连住3晚）",
    tips: "不同导航线路约6.5—9小时；带2岁宝宝按7—9小时预算，并在出发前一周用实时导航最终确认。"
  },
  {
    ...
    schedule: [
      "长途后的第二天睡到自然醒，午前前往太阳河森林公园",
      "看小熊猫、犀牛、熊狸和热带森林，优先观光车及低强度路线",
      "下午适时返回酒店午睡，晚上只在附近吃饭"
    ],
    play: ["太阳河森林公园", "小熊猫", "犀牛", "热带森林"],
    hotel: "同普洱酒店",
    tips: "10月1日不赶路；森林公园是北京不常见的低海拔动物与森林组合，适合宝宝。"
  },
  {
    id: 14, date: "第14天 10-02 周五", city: "普洱", alt: "约 1300m", drive: "近郊约 50km",
    img: "puerCoffee",
    title: "普洱第二整天 · 咖啡庄园 + 茶园",
    schedule: [
      "自然醒后选择一处市区周边、停车方便的咖啡庄园",
      "看咖啡果和烘焙过程，成年人品咖啡，宝宝在庄园草地活动",
      "午餐后回酒店午睡，傍晚梅子湖或洗马河公园散步"
    ],
    play: ["咖啡庄园", "咖啡果", "茶园", "城市公园"],
    hotel: "同普洱酒店",
    tips: "普洱不再只是中转，森林动物和茶咖庄园各占一个完整日。"
  },
  {
    ...
    title: "普洱 → 野象谷 → 西双版纳",
    schedule: [
      "自然醒后沿昆磨高速南下，野象谷就在进版纳方向途中",
      "游览亚洲象主题区域，优先索道或观光车，减少宝宝和老人步行",
      "午后继续开往景洪，入住同一家酒店连住四晚",
      "晚上只在酒店附近吃饭，不硬挤夜市"
    ],
    play: ["野象谷", "亚洲象", "雨林索道"],
    hotel: "景洪安静片区亲子酒店（连住4晚）",
    tips: "普洱到版纳路程短，野象谷顺路，不需要另占一个完整日。"
  },
  {
  ...
  },
  {
    ...
    schedule: [
      ...
      "全程以电瓶车为主，看王莲、棕榈、奇花异木",
      "下午适时返回酒店休息，晚上根据体力决定是否去告庄外围"
    ],
    play: ["热带植物园", "电瓶车", "王莲", "奇花异木"],
    hotel: "同景洪酒店",
    tips: "植物园距离景洪较远，但爷爷同行且对北京家庭差异最大，优先西区并减少步行。"
  },
  {
  ...
  },
  {
    ...
    schedule: [
      ...
      "爷爷奶奶乘下午动车从西双版纳站前往昆明，入住长水机场附近酒店",
      "爸爸妈妈、暄暄和姥姥开租车去普洱，约2—2.5小时",
      "傍晚到普洱入住，茶咖庄园项目留到明天"
    ],
    play: ["六口早餐", "爷爷奶奶动车返昆", "自驾普洱"],
    hotel: "普洱市区亲子酒店（连住2晚）",
    tips: "具体动车以开售后的12306为准，优先下午班并住机场酒店，避免10月8日当天赶航班。"
  },
  {
    ...
    title: "普洱完整日 · 茶咖庄园慢体验",
    schedule: [
      "自然醒后选择一处交通方便的咖啡庄园或茶园，看咖啡果、茶树和田园",
    ...
    play: ["咖啡庄园", "茶园", "城市公园"],
    hotel: "同普洱酒店",
    tips: "普洱不只作为过夜点，留出一个完整自然体验日；不安排博物馆。"
  },
  {
    id: 21, date: "第21天 10-09 周五", city: "普洱→昆明", alt: "约 1890m", drive: "约420km / 5—6h",
    img: "returnKunming",
    ...
    tips: "必须10月9日回到昆明，不能把普洱长途压到10月10日航班当天。"
  },
  {
...
export const globalTips = [
  ...
  { icon: "🛣️", title: "城市精简后的代价", text: "取消腾冲、芒市、楚雄、墨江后，路线更干净，但09-30大理直达普洱需按7—9小时准备；这是全程唯一不等自然醒的驾驶日。" },
