...
> = {
  ...
  'future-home': {
    ...
    shadowStyle: 'shadow-[0_6px_20px_-8px_rgba(251,146,60,0.5),0_2px_6px_-2px_rgba(245,158,11,0.25),inset_0_1px_0_rgba(255,255,255,0.9)]',
    titleColor: 'text-orange-700',
    subColor: 'text-orange-400/80',
    badgeBg: 'bg-white/80 ring-orange-200',
    badgeText: 'text-orange-600',
    bg: '🏡',
    corner: '🪴',
    image: 'icons/categories/growth.png',
    drawerGrad: 'from-orange-200 via-amber-100 to-yellow-100',
  },
  'mini-programs': {
